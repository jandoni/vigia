...
Rate of rise is fitted rather than differenced. Frame-to-frame differencing of
...
sample-based rather than time-based, was unaffected.
\end{recorded}
...
should be measured per camera rather than assumed.
...
is claimed as ours, and the comparison is reported rather than a winner
declared.
...
\emph{qualifies} the trend claim rather than supporting it unconditionally.
