\subsection{Scene routing for uploaded footage}
\label{sec:routing}
...
\subsubsection{Two rejected approaches}
...
\subsubsection{A trained scene classifier}
...
\subsubsection{Relationship to the context gate}
