...
This section restates the conclusions previewed in \cref{sec:preliminary},
now with the evidence behind them, and marks explicitly where the authors
regard the question as open. It is written to invite disagreement: each
claim below is tied to a table or an experiment a reader can re-run.
