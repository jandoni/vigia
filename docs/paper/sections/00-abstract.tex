...
that this document derives in closed form rather than only observing. We then
...
Two commitments are enforced in code rather than stated in prose. The runtime
