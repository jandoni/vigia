\subsection{Anticipatory flood-level estimation}
...
\subsubsection{Windowed least squares}
...
\subsubsection{Page--Hinkley change detection}
\label{sec:ph}
...
floor for a new camera and not a substitute for measuring it. Computed from
...
\subsubsection{Compared on real cameras}
...
\subsubsection{Validation against gauge measurements}
\label{sec:gage}
