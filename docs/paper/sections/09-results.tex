...
\begin{table}[htbp]
\centering\small
\caption{Measured by us. Every value is generated from the results file named
in the last column; none is typed into this document.}
\label{tab:measured}
...
model card publishes nothing, that is stated rather than filled in.}
\label{tab:reported}
\begin{tabularx}{\textwidth}{l L l}
\toprule
